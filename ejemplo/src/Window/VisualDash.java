...
public class VisualDash extends javax.swing.JDialog implements Observer{
    ...
    public VisualDash(java.awt.Frame parent, boolean modal, Simulator pSimulator) {
        ...
        theVisualRoad = new VisualPista();
        
        
        jLabel1.add(theVisualRoad.Paisaje);
        theVisualRoad.Paisaje.setVisible(true);
        
        TheSimulator = pSimulator;
        TheSimulator.chargeSystems(this);
        TheSimulator.TheRoad.VisualSystem = theVisualRoad;
    }
    ...
    private void jPanel1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jPanel1KeyPressed
        ...
        if(evt.getKeyCode()==KeyEvent.VK_D){
            ...
            if(theVisualRoad.Paisaje.getX() > -360)
                theVisualRoad.Paisaje.setLocation(theVisualRoad.Paisaje.getX()-30,0);
        }
        if(evt.getKeyCode()==KeyEvent.VK_A){
            System.out.println("Izquierda");
            if (theVisualRoad.Paisaje.getX() < 0)
                theVisualRoad.Paisaje.setLocation(theVisualRoad.Paisaje.getX()+30,0);
        }
